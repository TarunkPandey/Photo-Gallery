...
function selectPanel(panelId){ //PanelNo is variable and an arguement

    resetActivePanel() // It removes the active class from all the panels

    document.getElementById(panelId).classList.add('active') // classList helps us access class assigned to panel 
}
